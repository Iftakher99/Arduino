...
const int MotorRight_R_EN = 7; // Pin to control the clockwise direction of Right Motor
const int MotorRight_L_EN = 8; // Pin to control the counterclockwise direction of Right Motor 
const int MotorLeft_R_EN = 12; // Pin to control the clockwise direction of Left Motor
const int MotorLeft_L_EN = 13;////////////////////////////---- // Pin to control the counterclockwise direction of Left Motor
const int Rpwm1 = 5; // pwm output - motor A
const int Lpwm1 = 6; // pwm output - motor B
const int Rpwm2 = 9; // pwm output - motor A
const int Lpwm2 = 10; // pwm output - motor B
long pwmLvalue = 255;
long pwmRvalue = 255;
byte pwmChannel;
